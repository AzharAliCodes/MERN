              ...
              ({
                ...
                <tr className="border-b border-white border-opacity-50">
                  <td className="text-left py-2 w-2/5 flex items-center gap-2">
                    <img
                      src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267650/iplTeamLogo/${teamImageId}`}
                      alt={teamName}
                      className="w-6 h-6 object-contain"
                    />
                    <span>{teamName}</span>
                  </td>
                  <td className="text-left py-2">{matchesPlayed}</td>
                  <td className="text-left py-2">{matchesWon}</td>
